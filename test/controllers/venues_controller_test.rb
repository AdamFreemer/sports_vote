...
class VenuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venue" do
    assert_difference('Venue.count') do
      post venues_url, params: { venue: { lat: @venue.lat, long: @venue.long, name: @venue.name } }
    end
  ...
  test "should update venue" do
    patch venue_url(@venue), params: { venue: { lat: @venue.lat, long: @venue.long, name: @venue.name } }
