...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference('League.count') do
      post leagues_url, params: { league: { age_lower: @league.age_lower, age_upper: @league.age_upper, name: @league.name } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { age_lower: @league.age_lower, age_upper: @league.age_upper, name: @league.name } }
